                              ...
                              return GlassContainer(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text('Distance: ${provider.currentDistanceCm.toStringAsFixed(0)}cm', style: const TextStyle(color: Colors.white, fontSize: 11)),
                                    const SizedBox(width: 8),
        ...
        children: [
          ...
          ScaleTransition(
            ...
            child: GestureDetector(
              onTap: () {
                provider.setPoint(provider.currentLatitude, provider.currentLongitude, provider.currentBearing);
              },
              child: Container(
                width: 72,
                height: 72,
